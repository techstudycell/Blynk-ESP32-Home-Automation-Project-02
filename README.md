...
Enter a template name, select the hardware as ESP32, and the connection type will WiFi.
Then click on DONE.
...
After that, you have to create Datastreams. Here I will control 8 relays, so I have to create 8 Datastreams.
...
In a similar way, create 8 datastreams with virtual pin V1, V2, V3, V4, V5, V6, V7 and V8 to control 8 relays and 1 datastream with V9 to turn off all the relays together.
...
Add 9 Button widgets from Widget Box. (9th button will turn off all the relays together)
...
Now select the ESP32 1.0 board and proper PORT.
